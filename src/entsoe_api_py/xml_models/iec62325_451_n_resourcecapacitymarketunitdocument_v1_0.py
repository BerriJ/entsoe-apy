...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-n:resourcecapacitymarketunitdocument:1:0"
...
@dataclass
class MeteringPointAggregateNode:
    class Meta:
...
class TimeSeries:
    ...
    market_participation_market_object_status_status: Optional[StatusTypeList] = field(
        default=None,
        metadata={
