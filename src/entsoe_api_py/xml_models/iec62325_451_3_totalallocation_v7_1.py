...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-3:totalallocationresultdocument:7:1"
...
class NoBidAuctionTimeSeries:
    ...
    no_bid_auction_m_rid: Optional[str] = field(
        default=None,
        metadata={
    ...
    no_bid_reason: Optional[Reason] = field(
        default=None,
        metadata={
            "name": "NoBid_Reason",
            "type": "Element",
...
class TimeSeries:
    ...
    bid_document_market_document_bidding_party_market_participant_m_rid: Optional[
        PartyIdString
    ] = field(
        default=None,
        metadata={
    ...
    contract_market_agreement_m_rid: Optional[str] = field(
        default=None,
        metadata={
...
@dataclass
class TotalAllocationResultMarketDocument:
    class Meta:
