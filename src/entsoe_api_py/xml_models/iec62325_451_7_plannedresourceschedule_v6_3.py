...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-7:plannedresourcescheduledocument:6:3"
...
class EsmpDateTimeInterval:
    ...
    start: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:plannedresourcescheduledocument:6:3",
            "required": True,
...
@dataclass
class PlannedResourceTimeSeries:
    class Meta:
        name = "PlannedResource_TimeSeries"
...
@dataclass
class UnavailableReserveTimeSeries:
    class Meta:
    ...
    substitute_registered_resource_m_rid: Optional[ResourceIdString] = field(
        default=None,
        metadata={
            "name": "substitute_RegisteredResource.mRID",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:plannedresourcescheduledocument:6:3",
        },
    )
    ...
    substitute_resource_provider_market_participant_market_role_type: Optional[
        RoleTypeList
    ] = field(
        default=None,
        metadata={
            "name": "substituteResourceProvider_MarketParticipant.marketRole.type",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:plannedresourcescheduledocument:6:3",
        },
    )
...
@dataclass
class PlannedResourceScheduleMarketDocument:
    class Meta:
        name = "PlannedResourceSchedule_MarketDocument"
        namespace = (
            "urn:iec62325.351:tc57wg16:451-7:plannedresourcescheduledocument:6:3"
        )
    ...
    unavailable_reserves_time_series: list[UnavailableReserveTimeSeries] = field(
        default_factory=list,
        metadata={
            "name": "UnavailableReserves_TimeSeries",
            "type": "Element",
        },
    )
