...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-n:rasettlementdocument:1:2"
...
class Point:
    ...
    credit_price_amount: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "credit_Price.amount",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-n:rasettlementdocument:1:2",
            "required": True,
            "total_digits": 17,
    ...
    debit_price_amount: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "debit_Price.amount",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-n:rasettlementdocument:1:2",
            "required": True,
            "total_digits": 17,
...
class TimeSeries:
    ...
    market_product_market_product_type: Optional[MarketProductTypeList] = field(
        default=None,
        metadata={
...
@dataclass
class RasettlementMarketDocument:
    class Meta:
        name = "RASettlement_MarketDocument"
        namespace = "urn:iec62325.351:tc57wg16:451-n:rasettlementdocument:1:2"
