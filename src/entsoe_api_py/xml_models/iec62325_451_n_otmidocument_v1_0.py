...
@dataclass
class OtherTransparencyMarketInformationMarketDocument:
    class Meta:
    ...
    publication_date_and_or_time_date_time: Optional[XmlDateTime] = field(
        default=None,
        metadata={
    ...
    reason_code: Optional[ReasonCodeTypeList] = field(
        default=None,
        metadata={
            "name": "reason.code",
            "type": "Element",
