...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-n:energyprognosisdocument:1:0"
...
class EsmpDateTimeInterval:
    ...
    start: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-n:energyprognosisdocument:1:0",
            "required": True,
...
@dataclass
class UncertaintyPercentageQuantity:
    class Meta:
...
class EnergyPrognosisMarketDocument:
    class Meta:
        ...
        namespace = (
            "urn:iec62325.351:tc57wg16:451-n:energyprognosisdocument:1:0"
        )
