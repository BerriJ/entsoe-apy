...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-7:redispatchdocument:6:0"
...
class EsmpDateTimeInterval:
    ...
    start: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:redispatchdocument:6:0",
            "required": True,
...
class TimeSeries:
    ...
    dispatcher_market_participant_name: Optional[str] = field(
        default=None,
        metadata={
            "name": "dispatcher_MarketParticipant.name",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:redispatchdocument:6:0",
            "required": True,
        },
    ...
    impacted_domain_m_rid: Optional[AreaIdString] = field(
        default=None,
        metadata={
            "name": "impacted_Domain.mRID",
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:redispatchdocument:6:0",
            "required": True,
        },
...
@dataclass
class RedispatchMarketDocument:
    class Meta:
        name = "Redispatch_MarketDocument"
        namespace = "urn:iec62325.351:tc57wg16:451-7:redispatchdocument:6:0"
    ...
    redispatch_time_period_time_interval: Optional[EsmpDateTimeInterval] = field(
        default=None,
        metadata={
            "name": "redispatch_Time_Period.timeInterval",
            "type": "Element",
            "required": True,
        },
    )
