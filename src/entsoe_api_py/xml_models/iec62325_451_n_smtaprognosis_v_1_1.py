...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-n:smtaprognosisdocument:1:1"
...
@dataclass
class ShortMediumTermAdequacyPrognosisMarketDocument:
    class Meta:
    ...
    process_type_process_process_type: Optional[ProcessTypeList] = field(
        default=None,
        metadata={
