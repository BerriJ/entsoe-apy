...
@dataclass
class DomainAccountAceTariffType:
    class Meta:
        name = "DomainAccount_AceTariffType"

    type_value: Optional[TarifTypeTypeList] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    opening_point_quantity: Optional[Decimal] = field(
        default=None,
        metadata={
    ...
    closing_point_quantity: Optional[Decimal] = field(
        default=None,
        metadata={
...
class RgcesettlementMarketDocument:
    ...
    recording_period_time_interval: Optional[EsmpDateTimeInterval] = field(
        default=None,
        metadata={
