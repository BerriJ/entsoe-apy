...
def Transmission_params(
    ...
    """
    Request transmission data from ENTSO-E Transparency Platform.

    Args:
        document_type: Document type (e.g., A11, A59, A60, A61, A63, A64, A65,
                      A67, A70, A75, A85, A86, A87, A89, A90, A91, A92, A93)
