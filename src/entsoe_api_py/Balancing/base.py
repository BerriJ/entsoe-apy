...
def Balancing_params(
    ...
    """
    Request balancing data from ENTSO-E Transparency Platform.

    Args:
        document_type: Document type (e.g., A81, A82, A83, A84, A85, A86, A87,
                      A88, A89, A90, A91, A92, A93, A95, A96, A97, B33)
    ...
    if acquiring_domain:
        params["acquiring_Domain"] = acquiring_domain
    if connecting_domain:
        params["connecting_Domain"] = connecting_domain
    if control_area_domain:
        params["controlArea_Domain"] = control_area_domain
