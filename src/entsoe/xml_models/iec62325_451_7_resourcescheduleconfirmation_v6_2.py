...
__NAMESPACE__ = (
    "urn:iec62325.351:tc57wg16:451-7:resourcescheduleconfirmationdocument:6:2"
)
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-7:resourcescheduleconfirmationdocument:6:2",
...
class ResourceScheduleConfirmationMarketDocument(BaseModel):
    class Meta:
    ...
    original_market_document: OriginalMarketDocument = field(
        metadata={
            "name": "Original_MarketDocument",
            "type": "Element",
        }
