...
class PlannedResourceTimeSeries(BaseModel):
    class Meta:
...
class UnavailableReserveTimeSeries(BaseModel):
    class Meta:
    ...
    substitute_registered_resource_m_rid: None | ResourceIdString = field(
        default=None,
        metadata={
    ...
    substitute_resource_provider_market_participant_market_role_type: (
        None | RoleTypeList
    ) = field(
        default=None,
        metadata={
...
class PlannedResourceScheduleMarketDocument(BaseModel):
    class Meta:
    ...
    unavailable_reserves_time_series: list[UnavailableReserveTimeSeries] = (
        field(
            default_factory=list,
            metadata={
