...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-3:implicitauctiondocument:7:1"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-3:implicitauctiondocument:7:1",
...
class ImplicitAuctionResultMarketDocument(BaseModel):
    class Meta:
        name = "ImplicitAuctionResult_MarketDocument"
        namespace = (
            "urn:iec62325.351:tc57wg16:451-3:implicitauctiondocument:7:1"
        )
