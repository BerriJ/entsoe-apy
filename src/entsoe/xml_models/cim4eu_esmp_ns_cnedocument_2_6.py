...
__NAMESPACE__ = "https://cim4.eu/esmp/ns/cnedocument/1-4"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "https://cim4.eu/esmp/ns/cnedocument/1-4",
...
class MonitoredRegisteredResource(BaseModel):
    ...
    flow_based_study_domain_c_parameter_price_amount: None | Decimal = field(
        default=None,
        metadata={
            "name": "flowBasedStudy_Domain.c-Parameter_Price.amount",
            "type": "Element",
            "namespace": "https://cim4.eu/esmp/ns/cnedocument/1-4",
            "total_digits": 17,
        },
