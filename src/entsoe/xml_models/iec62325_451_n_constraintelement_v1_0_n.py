...
class ExternalConstraintSeries(BaseModel):
    class Meta:
        name = "ExternalConstraint_Series"
...
class RegisteredResource(BaseModel):
    ...
    shared_domain: list[Domain] = field(
        default_factory=list,
        metadata={
            "name": "Shared_Domain",
            "type": "Element",
...
class ConstraintSeries(BaseModel):
    ...
    external_constraint_series: list[ExternalConstraintSeries] = field(
        default_factory=list,
        metadata={
            "name": "ExternalConstraint_Series",
            "type": "Element",
...
class Point(BaseModel):
    ...
    constraint_time_series: list[ConstraintSeries] = field(
        default_factory=list,
        metadata={
...
class ConstraintNetworkElementMarketDocument(BaseModel):
    class Meta:
