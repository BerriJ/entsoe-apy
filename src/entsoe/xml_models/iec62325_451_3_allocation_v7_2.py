...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-3:allocationresultdocument:7:2"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-3:allocationresultdocument:7:2",
...
class TimeSeries(BaseModel):
    ...
    bid_original_market_document_m_rid: None | str = field(
        default=None,
        metadata={
    ...
    bid_original_market_document_revision_number: None | str = field(
        default=None,
        metadata={
    ...
    bid_original_market_document_bid_time_series_m_rid: None | str = field(
        default=None,
        metadata={
...
class AllocationResultMarketDocument(BaseModel):
    class Meta:
        name = "AllocationResult_MarketDocument"
        namespace = (
            "urn:iec62325.351:tc57wg16:451-3:allocationresultdocument:7:2"
        )
    ...
    subject_party_market_participant_m_rid: PartyIdString = field(
        metadata={
            "name": "subjectParty_MarketParticipant.mRID",
            "type": "Element",
        }
    )
    subject_party_market_participant_market_role_type: RoleTypeList = field(
        metadata={
