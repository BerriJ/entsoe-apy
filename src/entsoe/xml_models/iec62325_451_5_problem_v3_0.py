...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-5:problemdocument:3:0"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-5:problemdocument:3:0",
...
class ProblemStatementMarketDocument(BaseModel):
    class Meta:
    ...
    expected_market_document_type: MessageTypeList = field(
        metadata={
            "name": "expected_MarketDocument.type",
            "type": "Element",
        }
    )
    expected_market_document_created_date_time: str = field(
        metadata={
    ...
    expected_market_document_process_process_type: None | ProcessTypeList = (
        field(
            default=None,
            metadata={
    ...
    delivery_market_document_created_date_time: None | str = field(
        default=None,
        metadata={
