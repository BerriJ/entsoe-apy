...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-7:moldocument:7:3"
...
class BidTimeSeries(BaseModel):
    ...
    auction_payment_terms: None | PaymentTermsTypeList = field(
        default=None,
        metadata={
...
class MeritOrderListMarketDocument(BaseModel):
    ...
    related_reserve_bid_market_document_m_rid: None | str = field(
        default=None,
        metadata={
            "name": "relatedReserveBid_MarketDocument.mRID",
            "type": "Element",
            "max_length": 60,
        },
    )
    related_reserve_bid_market_document_revision_number: None | str = field(
        default=None,
        metadata={
            "name": "relatedReserveBid_MarketDocument.revisionNumber",
            "type": "Element",
            "pattern": r"[1-9]([0-9]){0,2}",
        },
    )
    time_series: list[BidTimeSeries] = field(
        default_factory=list,
        metadata={
            "name": "TimeSeries",
            "type": "Element",
