...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-3:publicationdocument:7:2"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-3:publicationdocument:7:2",
...
class TimeSeries(BaseModel):
    ...
    update_date_and_or_time_date_time: None | XmlDateTime = field(
        default=None,
        metadata={
