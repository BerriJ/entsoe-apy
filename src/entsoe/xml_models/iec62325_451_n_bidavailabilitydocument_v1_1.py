...
__NAMESPACE__ = "urn:iec62325.351:tc57wg16:451-n:bidavailabilitydocument:1:1"
...
class EsmpDateTimeInterval(BaseModel):
    ...
    start: str = field(
        metadata={
            "type": "Element",
            "namespace": "urn:iec62325.351:tc57wg16:451-n:bidavailabilitydocument:1:1",
...
class BidTimeSeries(BaseModel):
    ...
    requesting_party_market_participant_m_rid: None | PartyIdString = field(
        default=None,
        metadata={
...
class BidAvailabilityMarketDocument(BaseModel):
    class Meta:
        ...
        namespace = (
            "urn:iec62325.351:tc57wg16:451-n:bidavailabilitydocument:1:1"
        )
