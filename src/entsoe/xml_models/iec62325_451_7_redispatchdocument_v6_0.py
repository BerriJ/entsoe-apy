...
class TimeSeries(BaseModel):
    ...
    dispatcher_market_participant_name: str = field(
        metadata={
    ...
    impacted_domain_m_rid: AreaIdString = field(
        metadata={
...
class RedispatchMarketDocument(BaseModel):
    class Meta:
    ...
    redispatch_time_period_time_interval: EsmpDateTimeInterval = field(
        metadata={
