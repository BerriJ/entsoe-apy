...
class TestLogging:
    ...
    def test_utility_functions_have_logging(self):
        ...
        with patch('entsoe.utils.logger') as mock_logger:
            result = check_date_range_limit(202301010000, 202301020000, 365)
    ...
    def test_query_core_logging(self, mock_get):
        ...
        with patch('entsoe.query_api.logger') as mock_logger:
            result = query_core(params, timeout=10)
            ...
            request_log = next((arg for arg in call_args if "Making API request" in arg), None)
